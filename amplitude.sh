...
case $1 in
		...
		*)
		BUILD_KERNEL_OUT_DIR=$BUILD_TOP_DIR/okernel_12_1
		PRODUCT_OUT=$BUILD_TOP_DIR/okernel_12_1
...
FUNC_MKBOOTIMG()
{
	...
	rm ./amplitude_aosp_${MODEL}_${CARRIER}_${CERTIFICATION}.zip
	...
	zip -r ./amplitude_aosp_${MODEL}_${CARRIER}_${CERTIFICATION}.zip . || exit -1
        cd ~
